...
<div class="w3-container w3-padding">
    ...
    <div class="w3-card-4">
        ...
        <form method="post" class="w3-select w3-light-grey w3-padding">
            <label>FIO:
                <input type="text" required name="fio" class="w3-input w3-animate-input w3-border w3-round-large" style="width: 30%"><br />
            </label>
            <label>Phone number:
                <input type="text" required name="phone_number" class="w3-input w3-animate-input w3-border w3-round-large" style="width: 30%"><br />
            </label>
