...
<div class="w3-container w3-light-grey w3-opacity w3-center">
    <h1>Here you can add new res client</h1>
</div>
    ...
    <div class="w3-card-4">
        ...
        <form method="post" class="w3-select w3-light-grey w3-padding">
            ...
            <label>Id reservation:
                <input type="number" name="id_reservation" min="1"  required class="w3-input w3-animate-input w3-border w3-round-large" style="width: 30%"><br />
            </label>
