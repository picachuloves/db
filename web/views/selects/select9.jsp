<%@ page import="servlets.selects.Select9Servlet" %>
...
<div class="w3-container w3-blue-grey w3-opacity w3-center">
    <div class="w3-responsive">
        ...
        <br><br>
        <%
            List<Select9Servlet.Table> list = (List<Select9Servlet.Table>)request.getAttribute("list");
            if (list != null && !list.isEmpty()) {
                out.println("<table id=\"Table\">\n" +
                        ...
                        "            </thead>\n" +
                        "            <tbody id=\"myTable\">");
                for (Select9Servlet.Table c : list){
                    out.println("<tr>");
                    out.println("<th>" + c.getId() + "</th>");
                    out.println("<th>" + c.getRent() + "</th>");
                    out.println("</tr>");
                }
