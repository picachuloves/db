<%@ page import="servlets.selects.Select2Servlet" %>
...
<div class="w3-container w3-blue-grey w3-opacity w3-center">
    <div class="w3-responsive">
        <div class="w3-card-4">
            ...
            <form method="post" class="w3-select w3-light-grey w3-padding">
                ...
                <label>MIN people_number:
                    <input type="number" min="0" required name="people_number"  class="w3-input w3-animate-input w3-border w3-round-large" style="width: 30%"><br />
                </label>
        ...
        <br><br>
        <%
            List<Select2Servlet.Table> list = (List<Select2Servlet.Table>)request.getAttribute("list");
            if (list != null && !list.isEmpty()) {
                out.println("<table id=\"Table\">\n" +
                        "            <thead>\n" +
                        "            <tr class=\"header\">\n" +
                        "                <th style=\"width:50%;\">id_client</th>\n" +
                        "                <th style=\"width:50%;\">fio</th>\n" +
                        "            </tr>\n" +
                        "            </thead>\n" +
                        "            <tbody id=\"myTable\">");
                for (Select2Servlet.Table c : list){
                    out.println("<tr>");
