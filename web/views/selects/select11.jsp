<%@ page import="servlets.selects.Select11Servlet" %>
...
<div class="w3-container w3-blue-grey w3-opacity w3-center">
    <div class="w3-responsive">
        ...
        <br><br>
        <%
            List<Select11Servlet.Table> list = (List<Select11Servlet.Table>)request.getAttribute("list");
            if (list != null && !list.isEmpty()) {
                out.println("<table id=\"Table\">\n" +
                        "            <thead>\n" +
                        "            <tr class=\"header\">\n" +
                        "                <th style=\"width:50%;\">contract_number</th>\n" +
                        "                <th style=\"width:50%;\">information</th>\n" +
                        "            </tr>\n" +
                        "            </thead>\n" +
                        "            <tbody id=\"myTable\">");
                for (Select11Servlet.Table c : list){
                    out.println("<tr>");
