...
<%@ page import="servlets.selects.Select8Servlet" %><%--
...
<div class="w3-container w3-blue-grey w3-opacity w3-center">
    ...
    <div class="w3-responsive">
        ...
        <table id="Table">
            ...
            <tbody id="myTable">
            <%
                List<Select8Servlet.Table> list = (List<Select8Servlet.Table>) request.getAttribute("list");

                if (list != null && !list.isEmpty()) {
                    for (Select8Servlet.Table c : list) {
                        out.println("<tr>");
